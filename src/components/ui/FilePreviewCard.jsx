...
function FilePreviewCard({
  ...
  const handleFieldSave = (key, value) => {
    ...
    if (key === 'courseCode') onCourseCodeChange?.(value)
  ...
  return (
    <>
      ...
      >
        <div className="w-16 h-20 flex-none rounded-lg bg-black/30 border border-white/10 overflow-hidden flex items-center justify-center">
          {thumbnail ? (
