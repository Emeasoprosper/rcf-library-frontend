...
function ResourceDetail() {
  ...
  return (
    <div className="min-h-screen bg-background text-on-surface pb-32 md:pt-24 md:pl-80 lg:pr-80">
      ...
      <div className="fixed bottom-0 md:left-[var(--sb-left)] md:w-[var(--sb-w-md)] lg:w-[var(--sb-w-lg)] md:left-80 md:w-[calc(100%-20rem)] lg:w-[calc(100%-40rem)] left-0 right-0 md:left-80 lg:right-80 z-30 px-margin-mobile py-4 bg-background border-t border-outline flex gap-3">
        <button
